...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $sql = "INSERT INTO data_transaksi (`idTransaksi`, `tanggal`, `noMeja`, `nama`, `menu`, `jumlahMenu`, `harga`, `totalHarga`, `metodeBayar`, `status`)"
            . "VALUES ('$id','$tanggal', '$no','$nama','$menu','$jml','$harga','$total','$bayar','$status')";
...
<body style="background :linear-gradient(to right, #fbf8cc, #fde4cf) ;">
    <div class="container" style="display:flex; justify-content: center; align-items: center;font-family: 'Poppins', sans-serif;">
        <div class="card mb-5 p-5 shadow" style="height:54rem;width: 43rem; margin-top: 4rem;">
            <form method="post" action="">
                ...
                <div class="row g-2">
                    <div class="col-md">
                        <label for="exampleInputNo" class="form-label">ID</label>
                        <div class="mb-3">
                ...
                <div class="row g-2">
                    <div class="col-md">
                        <input class="form-check-input" type="radio" name="bayar" id="flexRadio1" value="Cash">
                        <label class="form-check-label" for="flexRadio1">Cash</label>
                    </div>
                    <div class="col-md">
                        <input class="form-check-input" type="radio" name="bayar" id="flexRadio2" value="Debit">
                ...
                <div class="mt-3 mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name="status" value="<?php echo $status; ?>">
                        ...
                        <option class="form-control" id="statusLunas">Lunas</option>
                        <option class="form-control" id="statusBelumLunas">Belum Lunas</option>
                    </select>
                </div>
                <?php
